...
def testManage(encoder, inputList):
    ...
    input_tensor = tensorFromSentence(input_lang, inputList)
...
if __name__ == "__main__":
    ...
    VideoPath = "./Extract_BindHead_2grams/"
    ...
    encoder = torch.load("./{}/{}/LSTM_CNN_Class_Lowest_Loss_validation_emb_dimension_{}_hidden_{}"\
    ...
    for indexTest in range(nrow_test):
        ...
        for listAlphabetFrame in listofAlphabetFrames:
            ...
            # class_seq should be [23, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18]
        ...
        error = wer(' '.join(GT_Word), ' '.join(word_pre))		# use space to separate eachAlphabet
    ...
    dataFrame_resultFile.to_csv("./{}/LSTM_CNN_Class_result_emb_dimension_{}_hidden_{}.csv"\
