...
if __name__ == "__main__":
    ...
    encoder = torch.load("./{}/{}/LSTM_CNN_Feature_Lowest_Loss_validation_emb_dimension_{}_hidden_{}"\
    ...
    for indexTest in range(nrow_test):
        ...
        for listAlphabetFrame in listofAlphabetFrames:
            ...
            class_seq = signSequenceAlphabet_feature['Feature_seq']
    ...
    dataFrame_resultFile.to_csv("./{}/LSTM_CNN_Feature_result_emb_dimension_{}_hidden_{}.csv"\
