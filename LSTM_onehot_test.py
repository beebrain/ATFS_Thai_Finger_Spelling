...
if __name__ == "__main__":
    ...
    VideoPath = "F://Video_rawFileHandsign\Extract_BindHead_2grams"
    ...
    encoder = torch.load("./{}/{}/LSTM_CNN_Onehot_Lowest_Loss_validation_emb_dimension_{}_hidden_{}"\
    ...
    dataFrame_resultFile.to_csv("./{}/LSTM_CNN_Onehot_result_emb_dimension_{}_hidden_{}.csv"\
